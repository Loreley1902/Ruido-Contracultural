...
export default async function PoemPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <article className="max-w-[600px] mx-auto px-6 md:px-10 py-12 md:py-14">
      ...
      <h1 className="font-serif text-2xl md:text-[2rem] leading-tight text-pearl mb-4 tracking-tight">
        {poem.title}
      </h1>
      ...
      <div className="font-serif italic text-base md:text-lg text-silver leading-loose mt-8">
